defmodule BookSearch.AuthorsTest do
  ...
  describe "authors" do
    ...
    test "list_authors/1 _ matching name" do
      ...
      assert Authors.list_authors("Jed Herne") == [author]
    end

    test "list_authors/1 _ partially matching name" do
      author = author_fixture(name: "Jed Herne")
      assert Authors.list_authors("Jed") == [author]
      assert Authors.list_authors("Her") == [author]
      assert Authors.list_authors("Herne") == [author]
      assert Authors.list_authors("JED") == [author]
      assert Authors.list_authors("hErnE") == [author]
    end
