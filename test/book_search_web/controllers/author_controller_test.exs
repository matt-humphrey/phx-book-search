defmodule BookSearchWeb.AuthorControllerTest do
  ...
  describe "index" do
    ...
    test "list all authors _ matching search query", %{conn: conn} do
      author = author_fixture(name: "JK Rowling")
      conn = get(conn, Routes.author_path(conn, :index, name: "Antony Pearce"))
  ...
  describe "create author" do
    test "redirects to show when data is valid", %{conn: conn} do
      ...
      assert get_flash(conn, :info) == "Badabing badaboom baby! Author created."
